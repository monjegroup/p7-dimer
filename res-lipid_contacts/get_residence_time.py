...
for n in range(1,64):
        ...
        xy4 = np.loadtxt(sys.argv[1] + "/chol_" + str(n) + ".dat", delimiter=' ')
        xy5 = np.loadtxt(sys.argv[1] + "/dops_" + str(n) + ".dat", delimiter=' ')
...
#save data
np.savetxt('cont_res_time_last500ns.dat', data, delimiter='\t', fmt='%.4f', newline='\n')
